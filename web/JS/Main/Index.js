...
if (CZCLZUser.UserID == "9b628843-8ff6-4100-a7f9-73b4043871ad")
    ...
    Ext.define('MainViewport', {
        ...
        initComponent: function () {
            ...
            me.items = [
            {
                ...
                html: '<div class="LoginHeader"><div class=leftHeader><a href="page/desktop/desktop.html" target="mainframe"><img alt="查货宝微信公众号" src="../images/logo/' + logo + '"></a></div><div class="rightHeader"><a href="page/desktop/desktop.html" target="mainframe"><img align="absmiddle" src="approot/d/images/home.png">首页</a><a href="approot/r/help.aspx"><img align="absmiddle" src="approot/d/images/help.png">帮助</a><a onclick="logout()" href="javascript:void(0);"><img align="absmiddle" src="approot/d/images/exit.png">退出</a></div></div>'
